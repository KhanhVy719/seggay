...
app.listen(port, () => {
    ...
    console.log(`Serving uploads: http://localhost:${port}/upload`);
    console.log(`Local player: http://localhost:${port}/player?src=/upload/<date>/<jobId>/master.m3u8`);
    console.log(`Carrier player: http://localhost:${port}/player?jobId=<jobId>`);
});
